...
<body>
    ...
    <form method="POST" action="/reset" class="p-2 2m:pl-10 2m:pr-10 mmmm:pr-20 mmmm:pl-20 llll:pl-48 llll:pr-48 pt-0 pb-28 bg-gradient-to-b from-stone-900/90 to-slate-600/50">
        @csrf
