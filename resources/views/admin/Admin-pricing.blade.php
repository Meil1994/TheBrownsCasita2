<div>
    ...
    <div class="p-2 pt-10 mm:p-20 mm:pt-20 bg-slate-300 h-screen overflow-auto">
            ...
            <form 
                ...
                <div>
                    <div class="form-group pl-1 mb-3 bg-slate-400 pb-2 pr-1 pt-1">
                        ...
                        <div class="flex">
                            <span class="border pr-2 border-r-0 border-slate-500 rounded-tl-md rounded-bl-md pl-2 bg-white">PHP</span>
                            <input type="text" name="price" value="{{ $discount->price }}" class="border-l-0 form-control border border-slate-500 rounded-tr-md rounded-br-md w-100 p-2 pt-0 pb-0 pl-10">
                        </div>
                        @error('price')
                    ...
                    <div class="bg-slate-400 pb-2 pr-1 pt-1">
                        <div class="form-group pl-1 ">
                            <label for="discount_1">Discount 1 in percent</label>
                            <div class="flex">
                        ...
                        <div class="form-group pl-1 mt-1">
                    ...
                    <div class="bg-slate-400 pb-2 pr-1 pt-1 mt-3">
                        <div class="form-group pl-1">
                            <label for="discount_2">Discount 2 in percent</label>
                            <div class="flex">
                    ...
                    <div class="bg-slate-400 pb-2 pr-1 pt-1 mt-3">
                        <div class="form-group pl-1">
                            <label for="discount_3">Discount 3 in percent</label>
                            <div class="flex">
