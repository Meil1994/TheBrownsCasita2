<div class="p-4 grid grid-cols-1 divide-x tracking-2 l:grid-cols-3 l:mt-20">
    ...
    <div class="block mmm:flex border-none 2m:p-10 2m:pt-0 l:mt-10 l:col-span-2 l:pl-0 l:ml-0">
        <img class="h-300 w-100 p-1 bg-slate-100 mt-10 mmm:m-1" src="{{asset('images/photo7.jpeg')}}" alt=""/>
        <img class="hidden 3m:block w-100 h-300 p-1 bg-slate-100 mt-10 mmm:m-10 mmm:ml-0 mmm:mr-0" src="{{asset('images/photo14.jpeg')}}" alt=""/>
        <img class="h-300 w-100 p-1 bg-slate-100 mt-10 mmm:mt-20 mmm:m-1" src="{{asset('images/photo8.jpeg')}}" alt=""/>
    </div>
