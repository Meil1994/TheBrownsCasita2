...
<nav>
    ...
    <div class="grid grid-cols-6 p-4 pt-2 pb-2 633:p-20 633:pb-2 633:pt-2 l:p-40 l:pt-2 l:pb-2">
        <div class="col-span-2">
            <a href="/home"><img src="images/tbc.png" class="h-20 w-20 rounded-full"/></a>
        </div>
        ...
        <div class="col-span-4">
            <ul class="flex justify-end 596:justify-between items-center h-100">
                ...
                <li class="883:hidden ring-2 p-1 rounded-md"><button id="burger"><i class="fa-sharp fa-solid fa-bars"></i></button></li>
