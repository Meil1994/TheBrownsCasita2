<div class="bg-black">
    <div class="grid llll:grid-cols-4 mmmmm:grid-cols-2 divide-x tracking-2 p-10 pt-0 mm:p-20">
        <div class="text-white border-none l:p-10 l:pt-0 l:pb-0">
           <h1 class="text-2xl">Address</h1>
           <p class="mt-5 font-light">Brgy. Cebulano, Carmen, Davao del Norte</p>
        ...
        <div class="text-white border-none l:p-10 l:pt-0 l:pb-0">
            ...
            <p class="mt-5 font-light">+63 9369361714</p>
            <p class="font-light">tbc@gmail.com</p>
        </div>
    
        <div class="text-white border-none l:p-10 l:pt-0 l:pb-0">
            <h1 class="text-2xl mt-10 llll:mt-0">Social</h1>
            <button class="mt-5 hover:text-indigo-500 font-light tracking-2">Facebook</button>
            <br/>
            <button class="hover:text-indigo-500 font-light tracking-2">Instagram</button>
        </div>
    
        <div class="text-white border-none l:p-10 l:pt-0 l:pb-0">
            <h1 class="text-2xl">Your Feedback</h1>
           <textarea class="mt-5 text-black h-40 w-100"></textarea>
           <br/>
           <button class="border border-white w-100 bg-indigo-500 h-10 hover:border-indigo-500 hover:text-indigo-500 hover:bg-white">Send</button>
        </div>
    </div>
