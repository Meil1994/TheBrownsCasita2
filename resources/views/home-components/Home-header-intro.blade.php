...
<div class="text-center text-white mt-200 pb-110 tracking-2">
    <h1 class="text-60">The Browns Casita</h1>
    <p class="text-30 font-light">Enjoy the Tropical Hideaway!</p>
